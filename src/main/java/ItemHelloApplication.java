...
public class ItemHelloApplication extends Application {
    ...
    private ItemForm nextObj;
    private ItemForm waitObj;
    ...
    public ItemHelloApplication(SizeConstants sizeConstants, Settings settings, ItemController itemController){
        ...
        this.waitObj = itemController.waitingTextMake(ItemBlockColor.colorBlindMode, difficultylevel, item, itemRotate);
        this.nextObj = itemController.makeText(ItemBlockColor.colorBlindMode, difficultylevel, item, itemRotate);
    ...
    public void start(Stage stage) throws IOException {
        ...
        moveOnKeyPress(a);
        object = a;
        nextObj = itemController.makeText(ItemBlockColor.colorBlindMode,difficultylevel,item,itemRotate);//색맹 모드가 아님을 의미
