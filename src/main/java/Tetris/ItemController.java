...
public class ItemController {
    ...
    public ItemForm makeText(boolean colorBlindMode, char difficultyLevel,String item,int itemRotate) {
    ...
    public ItemForm waitingTextMake(boolean colorBlindMode, char difficultyLevel, String item, int itemRotate){
        ItemForm waitObj;
        if(item == "Weight"){
